...
<script>
    ...
    import EmailPersonSelectPop from "../../../components/admin/email/EmailPersonSelectPop.svelte";
    import EmailBookPop from "../../../components/admin/email/EmailBookPop.svelte";
    ...
    const handleOnSubmitBtnClick = () => {
        ...
        ajaxMultipart('/v4/api/Email/systemSendEmail', sendForm, (res) => {
            try {
                ...
                push($emailSendData.emType === '1' ? '/admin/emailSendComplete' : '/admin/emailBookComplete');
            } catch (e) {
