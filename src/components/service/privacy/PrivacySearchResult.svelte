            ...
            <div>
                <div class="sea_reInner">
                    ...
                    <div class="koinputshowhideBox">
                        <div class="koinput">
                            <input type="text" name="all" id="all" class="wid360" placeholder="이름, 이메일, 생년월일, 휴대폰번호 검색"></input>
                ...
                <div class="koko_check">
                    ...
                    <label for="result_research">
                        <em></em>
                        <p class="check">결과 내 재검색</p>
                    </label>
                </div>
            </div>
