...
// node_modules/svelte-apexcharts/src/index.js
var import_apexcharts = __toESM(require_apexcharts_common());
var chart = (node, options) => {
  let myChart = new import_apexcharts.default(node, options);
  myChart.render();
  return {
    update(options2) {
      myChart.updateOptions(options2);
    }
  };
};
export {
...
apexcharts/dist/apexcharts.common.js:
   ...
   *)
*/
//# sourceMappingURL=svelte-apexcharts.js.map
