...
var require_verbalexpressions = __commonJS({
  "node_modules/verbal-expressions/dist/verbalexpressions.js"(exports, module) {
        ...
        _createClass(VerbalExpression2, [{
          ...
          value: function range() {
            ...
            for (var i = 1; i < arguments.length; i += 2) {
              var from = VerbalExpression2.sanitize(arguments.length <= i - 1 ? void 0 : arguments[i - 1]);
              var to = VerbalExpression2.sanitize(arguments.length <= i ? void 0 : arguments[i]);
              value += from + "-" + to;
            }
            return this.add("[" + value + "]");
          }
...
export default require_verbalexpressions();
...
verbal-expressions/dist/verbalexpressions.js:
   ...
   *)
*/
//# sourceMappingURL=verbal-expressions.js.map
